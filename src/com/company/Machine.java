...
public class Machine extends Player{
    ...
    */
     ...
     */
        ...
        public int getElement(int[][] coordinates, int row, int col) {
     ...
     */
        public void logShot(int[][] shotArray, int[][] guess){

            int[] arrayValue = {1};

            shotArray[0][1] = guess[0][1];
            shotArray[0] = arrayValue;
            shotArray[1] = arrayValue;
